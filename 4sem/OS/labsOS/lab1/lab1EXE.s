...
output_dec_byte:
	...
	mov  byte [output_dec_byte.outstr], '0'
	mov  byte [output_dec_byte.outstr + 1], '0'
	mov  byte [output_dec_byte.outstr + 2], '0'
	...
	.conv_dec:
		...
		mov  cx, ax
		add  dl, '0'
		mov  [output_dec_byte.outstr + di], dl
		dec  di
	cmp cx, 0
	jne .conv_dec

	mov  dx, output_dec_byte.outstr + 1
	mov  ah, 0x9
	int 0x21
